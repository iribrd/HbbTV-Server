...
<!-- .................................................................................................................................................  -->
        ...
        <div class="col offset-2" id="main">
			...
			<div class="table-responsive-sm">
                              <table id='my_table'  class="table table-striped table-wrapper-scroll table-bordered table-condensed table-sm"   
                                  style="overflow-x:scroll; overflow-y:scroll;  height:200px;" cellspacing="0" width="100%">
                                <caption> URL and Carousel Apps </caption>
                                 ...
                                 <tr>
									...
									<th>Setting ID</th>
									<th>id</th>
                                                                        <th>transport protocol id</th>
									<th>name</th>
									<th style="display:none">organisation_id</th>
									<th style="display:none">type</th>
									<th>version</th>
									<th style="display:none">pmt version</th>
									...
									<th >carousel id</th>	
                                                                        <th>stream event component tag</th>
									...
									<th style="display:none">smart compress</th>
                                                                        <th style="display:none">mount frequency</th>
							...
							<td><?php echo $val['application_id'];?></td> 
                                                        <td><?php echo $tp_id[$val['transport_protocol_id']];?></td>
							...
							<td style="display:none"><?php echo $val['pmt_version'];?></td>
							...
							<td><?php echo $val['application_index_file'];?></td>
                                                        <td><?php echo $app_usage[$val['application_usage']];?></td>
							...
							<td style="display:none"><?php echo $val['smart_compress_the_carousel'];?></td>
                                                        <td style="display:none"><?php echo $val['mount_frequency'];?></td>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body" style="background-color:lavender;">
            <form action="new_app_insert.php" method="POST"> 
		    <div class="form-group row">
                            ...
                            <div class="inputGroupContainer">
                                <div class="input-group">
                                  <select class="selectpicker form-control" name="transport_protocol_id"  id="transport_protocol_id">
                                     <option value='0' onclick="show2()"selected> 0x0003 Transport via HTTP </option>
                    ...
                    <div class="form-group col-md-4">
                            <label class="control-label " for="app_usage"> application_usage </label>
                            <div class="inputGroupContainer">
                                <div class="input-group">
                                  <select class="selectpicker form-control" name="app_usage"  id="app_usage">
                                     <option value='0'selected> red button </option>
                                    <option value='1'  >teletext  </option>
                    ...
                    <div class="form-group col-md-4">
                            ...
                            <a href="#" title="App control code" data-toggle="popover" data-placement="bottom" data-content="00 NOT_VISIBLE_ALL This application shall
                                                                not be visible either to applications via an application
                                                                ...
                                                                01 NOT_VISIBLE_USERS This application shall not be visible to users but shall be visible to
                                                                applications via an application listing API (if such an API is supported by the terminal).
                    ...
                    <div class="form-group col-md-4">
                            <label class="control-label" for="App_path" id="app_path_lable" >application_URL </label>
                            <input type="text" id="App_path" name="App_path"  required="required" class="form-control" value="77.36.157.4/h1/whitelabel/redbutton/" />
                    </div>
					...
					<script>
						...
						if (this.value ==="1"){
								document.getElementById('carousel_div1').style.display = 'block';
                                                                ...
                                                                document.getElementById('carousel_div6').style.display = 'block';
                                                                document.getElementById('carousel_div7').style.display = 'block';

                                document.getElementById('App_path').value = '';
                                document.getElementById('App_index').value = '';
                                document.getElementById('app_path_lable').innerHTML = 'application_folder';
							...
							document.getElementById('carousel_div1').style.display = 'none';
                                                        ...
                                                        document.getElementById('carousel_div6').style.display = 'none';
                                                        document.getElementById('carousel_div6').style.display = 'none';


                                document.getElementById('app_path_lable').innerHTML = 'application_URL';
...
<!--			<div class="col-md-12 row"  id="carousel_div" style= display:none > -->
                        ...
                        <div class="form-group col-md-4"  id="carousel_div5" style= display:none>
                            <label class="control-label" for="mount_frequency"> frequency of DII/DSI/SGW </label>
                            <input maxlength="6" type="number"  name="mount_frequency" id="mount_frequency" required="required" class="form-control" value="2" />
                        </div>



                        <div class="form-group col-md-4" id="carousel_div6" style= display:none>
                        ...
                        <div class="form-group col-md-4"  id="carousel_div7" style= display:none>
                            <label class="control-label" for="component_tag"> stream_event component_tag </label>
                            <input maxlength="6" type="number"  name="component_tag" id="component_tag" required="required" class="form-control" value="0" />
                        </div>
              ...
              <div class="row">
				...
				<div class="col-sm-7 col-xs-6 ">
				    <div id="viewapplication_id"></div>
                                ...
                                <div class="col-sm-5 col-xs-6 tital " >
                                    <strong>transport protocol id:</strong>
                                </div>
                                <div class="col-sm-7 col-xs-6 ">
                                   <div id="viewtransport_protocol_id"></div>
                                </div>
                                ...
                                <div class="col-sm-7 col-xs-6 ">
                                   <div id="viewapplication_usage"></div>
                                </div>
...
<!---carousel...............................................-->				
		<div   class="row"  id="view_carousel_part"   style='display:none'>
				...
				<div class="col-sm-5 col-xs-6 tital " >
					<strong>DSMCC association_tag:</strong>
				</div>
				<div class="col-sm-7 col-xs-6 " >
				...
				<div class="col-sm-7 col-xs-6 ">
					<div id="viewDDB_size"></div>
                                ...
                                <div class="col-sm-5 col-xs-6 tital " >
                                        <strong>DII/DSI/SGW_frequency:</strong>
                                </div>
                                <div class="col-sm-7 col-xs-6 ">
                                        <div id="viewmount_frequency"></div>
                                </div>
				...
				<div class="col-sm-7 col-xs-6 " >
					<div id="viewsmart_compress_the_carousel"></div>
                                ...
                                <div class="col-sm-5 col-xs-6 tital " >
                                    <strong>stream event component tag:</strong>
                                </div>

                                <div class="col-sm-7 col-xs-6 ">
                                   <div id="viewcomponent_tag"></div>
                                </div>
...
<div class="modal fade" id="app_updateModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
		 <form action="new_app_update.php" method="POST">
		  <div class="row">
			<input type="hidden" name="app_updateId" id="app_updateId">
			
                           
                                <div class="form-group  col-md-4">
								<label class="control-label" for="updatetransport_protocol_id">transport protocol  id</label>								
                                  <select class="selectpicker form-control" name="updatetransport_protocol_id"  id="updatetransport_protocol_id">
                                     <option value='0' selected> 0x0003 Transport via HTTP </option>
                                    <option value='1' >0x0001 Object Carousel   </option>
                                  </select>
                                </div>
                           
                    <div class="form-group col-md-4">
                            <label class="control-label " for="updateapp_usage"> application_usage </label>
                            <div class="inputGroupContainer">
                                <div class="input-group">
                                  <select class="selectpicker form-control" name="updateapp_usage"  id="updateapp_usage">
                                     <option value='0'selected> red button </option>
                                    <option value='1'  >teletext  </option>
		...
		<div class="form-group  col-md-4">
		  ...
		  <div   class="form-group  col-md-4">
                    ...
                    <div class="form-group  col-md-4">
                            <label class="control-label" for="updateapplication_folder_path" id="update_app_path_lable">application_URL </label>
				...
				<script>
						$('#updatetransport_protocol_id').on('change',function(){
						if (this.value =="1"){
								document.getElementById('ucarousel_div1').style.display = 'block';
                                                                ...
                                                                document.getElementById('ucarousel_div6').style.display = 'block';
                                                                document.getElementById('ucarousel_div7').style.display = 'block';
								...
								document.getElementById('updateDDB_size').required=true;
		 						document.getElementById('updatesmart_compress_the_carousel').required=true;
	                                                       	document.getElementById('updatemount_frequency').required=true; 
				                                document.getElementById('updateapplication_folder_path').value = '';
                                				document.getElementById('updateapplication_index_file').value = '';
				                                document.getElementById("update_app_path_lable").innerHTML = 'application_folder';

								}
						else{
							document.getElementById('ucarousel_div1').style.display = 'none';
							document.getElementById('ucarousel_div2').style.display = 'none';
							document.getElementById('ucarousel_div3').style.display = 'none';
							document.getElementById('ucarousel_div4').style.display = 'none';
							document.getElementById('ucarousel_div5').style.display = 'none';
                                                        document.getElementById('ucarousel_div6').style.display = 'none';
                                                        document.getElementById('ucarousel_div7').style.display = 'none';

							document.getElementById('updatecarousel_id').required=false;
							document.getElementById('updatecarousel_association_tag').required=false;
							document.getElementById('updatemodule_version').required=false;
							document.getElementById('updateDDB_size').required=false;
							document.getElementById('updatesmart_compress_the_carousel').required=false;
                                                        document.getElementById('updatemount_frequency').required=false;
        			                        document.getElementById("update_app_path_lable").innerHTML = 'application_URL';
                        ...
                        <div class="form-group col-md-4"  id="ucarousel_div5" style= display:none>
                            <label class="control-label" for="updatemount_frequency"> frequency of DII/DSI/SGW </label>
                            <input maxlength="6" type="number"  name="updatemount_frequency" id="updatemount_frequency" required="required" class="form-control" 
			value="2" />
                        </div>



                        <div class="form-group col-md-4" id="ucarousel_div6" name="ucarousel_div6" style= 'display:none'>
                        ...
                        <div class="form-group col-md-4"  id="ucarousel_div7" style= display:none>
                            <label class="control-label" for="updatecomponent_tag"> stream event component tag </label>
                            <input maxlength="6" type="number"  name="updatecomponent_tag" id="updatecomponent_tag"  class="form-control" value='0' />
                        </div>
  ...
  <div class="modal fade" id="app_deleteModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="new_app_delete.php" method="POST">
  ...
  <script>
    $(document).ready(function () {
      $('.updateBtn').on('click', function(){
        ...
        console.log(data);
	if(data[2]=='url') tp_id_index=0; else tp_id_index=1;
        if(data[14]=='teletext') app_use=1; else app_use=0;

        document.getElementById('updatetransport_protocol_id').selectedIndex=tp_id_index;
        $('#app_updateId').val(data[0]);
		$('#updateapplication_id').val(data[1]);
		$('#updateapplication_name').val(data[3]);
		$('#updateorganisation_id').val(data[4]);
		$('#updateapplication_type').val(data[5]);
		$('#updateapplication_version').val(data[6]);
		$('#updatepmt_version').val(data[7]);
		document.getElementById('updateapplication_control_code').selectedIndex=data[8];
		document.getElementById('updateapplication_visibility').selectedIndex=data[9];
		$('#updateservice_bound_flag').val(data[10]);
		$('#updateapplication_priority').val(data[11]);
		$('#updateapplication_folder_path').val(data[12]);
		$('#updateapplication_index_file').val(data[13]);
                document.getElementById('updateapp_usage').selectedIndex=app_use;
		document.getElementById('updateapplication_profile').selectedIndex=data[15];
		$('#updateapplication_profile_maj').val(data[16]);
		$('#updateapplication_profile_min').val(data[17]);
		$('#updateapplication_profile_mic').val(data[18]);


	    if (tp_id_index==1) {
		$('#updatecarousel_id').val(data[19]);
                $('#updatecomponent_tag').val(data[20]);
		$('#updatecarousel_association_tag').val(data[21]);
		$('#updatemodule_version').val(data[22]);		
		$('#updateDDB_size').val(data[23]);	
                $('#updatemount_frequency').val(data[25]);

		document.getElementById('updatesmart_compress_the_carousel').selectedIndex=data[24];	
	        document.getElementById("ucarousel_div1").style.display ="block";
	        document.getElementById('ucarousel_div2').style.display = 'block';
	        document.getElementById('ucarousel_div3').style.display = 'block';
	        document.getElementById('ucarousel_div4').style.display = 'block';
  ...
  <script>
	...
	tpid=["transport via HTTP","Object Carousel"];		
	app_ctl=["AUTOSTART","PRESENT","DISABLED","KILL"];
	app_vis=["NOT_VISIBLE_ALL","NOT_VISIBLE_USERS","VISIBLE_ALL"];
	profile=["0x0000 basic profile","0x0001 download" ,"0x0002 PVR","0x0004 RTSP"];
	s_b_flag=["0: app is not  associated with the current service","1: app is only associated with the current service"];
	compress=["0:don't compress","1:compress all","2:smart compress"];
	
        console.log(data);
            
			$('#viewapplication_id').text(data[1]);
		        $('#viewtransport_protocol_id').text(data[2]);
			$('#viewapplication_name').text(data[3]);
			$('#vieworganisation_id').text(data[4]);
			$('#viewapplication_type').text(data[5]);
			$('#viewapplication_version').text(data[6]);
			$('#viewpmt_version').text(data[7]);
			$('#viewapplication_control_code').text(app_ctl[data[8]]);
			$('#viewapplication_visibility').text(app_vis[data[9]]);
			$('#viewservice_bound_flag').text(s_b_flag[data[10]]);
			$('#viewapplication_priority').text(data[11]);
			$('#viewapplication_folder_path').text(data[12]);
			$('#viewapplication_index_file').text(data[13]);
                        $('#viewapplication_usage').text(data[14]);
			$('#viewapplication_profile').text(data[15]);
			$('#viewapplication_profile_maj').text(data[16]);
			$('#viewapplication_profile_min').text(data[17]);
			$('#viewapplication_profile_mic').text(data[18]);
			if(data[2]=='url'){
			...
			$('#viewcarousel_id').text(data[19]);
                        $('#viewcomponent_tag').text(data[20]);

			$('#viewcarousel_association_tag').text(data[21]);
			$('#viewmodule_version').text(data[22]);		
			$('#viewDDB_size').text(data[23]);	
			$('#viewsmart_compress_the_carousel').text(compress[data[24]]);
                        $('#viewmount_frequency').text(data[25]);
